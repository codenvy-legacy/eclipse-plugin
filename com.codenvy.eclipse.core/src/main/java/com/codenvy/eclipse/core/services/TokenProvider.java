...
public interface TokenProvider {
    /**
     * Get a {@link CodenvyToken} presumably from {@link SecureStorageService} for the given URL and username.
     * 
     * @param url the Codenvy platform URL.
     * @param username the username.
     * @return the {@link CodenvyToken} associated to these URL and username or {@code null} if none can be found.
    ...
    /**
     * Renew the {@link CodenvyToken} through a new authentication towards the given Codenvy platform URL and username. This will be
     ...
     * @param url the Codenvy platform URL.
     * @param username the username.
     * @return the {@link CodenvyToken} associated to these URL and username or {@code null} if no password can be found for this
     ...
     */
    CodenvyToken renewToken(String url, String username);
}
